...
import com.example.BackendWebbanhang.domain.response.user.LoginDTO;
import com.example.BackendWebbanhang.domain.response.user.ResCreateUserDTO;
import com.example.BackendWebbanhang.domain.response.user.ResLoginDTO;
import com.example.BackendWebbanhang.service.UserService;
...
public class AuthController {
    ...
    public ResponseEntity<ResLoginDTO> login(@Valid @RequestBody LoginDTO loginDto) {
        ...
        if (currentUserDB != null) {
            ...
            if (currentUserDB.getRole() != null) {
                ...
                roleLogin.setId(currentUserDB.getRole().getId());
                roleLogin.setName(currentUserDB.getRole().getName());
    ...
    public ResponseEntity<ResLoginDTO.UserGetAccount> getAccount() {
        ...
        if (currentUserDB != null) {
            ...
            if (currentUserDB.getRole() != null) {
                userLogin.setRole(new ResLoginDTO.RoleLogin(
    ...
    public ResponseEntity<ResCreateUserDTO> register(@Valid @RequestBody User postManUser) throws IdInvalidException {
        ...
        // TÌM ROLE USER TỪ DB VÀ GÁN VÀO USER TRƯỚC KHI LƯU
